...
func NewDatabaseVaultStorage(dbPath string) (*DatabaseVaultStorage, error) {
	...
	return &DatabaseVaultStorage{db: db}, nil
}

func (v *DatabaseVaultStorage) SetUserInfo(pubHex string, info UserInfo) error {
...
func (v *DatabaseVaultStorage) GetUserInfo(pubHex string) (UserInfo, error) {
	var info UserInfo
...
func (v *DatabaseVaultStorage) GetUserInfoByUsername(username string) (UserInfo, error) {
	var info UserInfo
...
func (v *DatabaseVaultStorage) SetUserSecret(userID, secret string) error {
	_, err := v.db.Exec(`INSERT OR REPLACE INTO credentials (user_id, secret, secret_type) VALUES (?, ?, 'password')`, userID, secret)
	return err
}

func (v *DatabaseVaultStorage) GetUserSecret(userID string) (string, error) {
	var secret string
...
func (v *DatabaseVaultStorage) SetUserPublicKey(userID string, pubKeyX, pubKeyY string) error {
...
func (v *DatabaseVaultStorage) GetUserPublicKey(userID string) (map[string]string, error) {
	var secret string
...
func (v *DatabaseVaultStorage) CreateClient(client *Client) error {
...
func (v *DatabaseVaultStorage) GetClient(clientID string) (*Client, error) {
	var client Client
...
func (v *DatabaseVaultStorage) UpdateClient(client *Client) error {
	redirectURIsJSON, _ := json.Marshal(client.RedirectURIs)
	scopesJSON, _ := json.Marshal(client.Scopes)
...
func (v *DatabaseVaultStorage) ListClients() ([]*Client, error) {
...
func (v *DatabaseVaultStorage) CreateAuthorizationCode(code *AuthorizationCode) error {
...
func (v *DatabaseVaultStorage) GetAuthorizationCode(code string) (*AuthorizationCode, error) {
...
func (v *DatabaseVaultStorage) UseAuthorizationCode(code string) error {
	_, err := v.db.Exec(`UPDATE authorization_codes SET used = 1 WHERE code = ?`, code)
	return err
}

func (v *DatabaseVaultStorage) CreateAccessToken(token *AccessToken) error {
...
func (v *DatabaseVaultStorage) GetAccessToken(token string) (*AccessToken, error) {
...
func (v *DatabaseVaultStorage) RevokeAccessToken(token string) error {
	_, err := v.db.Exec(`DELETE FROM access_tokens WHERE token = ?`, token)
	return err
}

func (v *DatabaseVaultStorage) CreateRefreshToken(token *RefreshToken) error {
...
func (v *DatabaseVaultStorage) GetRefreshToken(token string) (*RefreshToken, error) {
...
func (v *DatabaseVaultStorage) RevokeRefreshToken(token string) error {
	_, err := v.db.Exec(`DELETE FROM refresh_tokens WHERE token = ?`, token)
	return err
}

// MFA methods implementation
func (v *DatabaseVaultStorage) SetUserMFA(userID string, secret string, backupCodes []string) error {
...
func (v *DatabaseVaultStorage) GetUserMFA(userID string) (string, []string, error) {
...
func (v *DatabaseVaultStorage) EnableMFA(userID string) error {
	_, err := v.db.Exec(`UPDATE users SET mfa_enabled = 1 WHERE user_id = ?`, userID)
	return err
}

func (v *DatabaseVaultStorage) DisableMFA(userID string) error {
	_, err := v.db.Exec(`UPDATE users SET mfa_enabled = 0 WHERE user_id = ?`, userID)
	return err
}

func (v *DatabaseVaultStorage) IsUserMFAEnabled(userID string) (bool, error) {
	var mfaEnabled bool
...
func (v *DatabaseVaultStorage) ValidateBackupCode(userID, code string) error {
...
func (v *DatabaseVaultStorage) InvalidateBackupCode(userID, code string) error {
